  ...
  <div class="cent_cuad">
    ...
    <div class="cuadro_cont">
      ...
      <div class="text_descr_3">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form" method="post" id="form-presupuesto" name="form-presupuesto">
          ...
          <fieldset>
            <div class="col_1">
              ...
              <input class="caj1" id="piso_origen" name="piso_origen" data-name="piso_origen" type="text" placeholder="<?= t('t_for_piso_origen'); ?>" required="required" />
              <label class="lb_1">
                <?= t('t_for_ascensor'); ?>
              </label>
            ...
            <div class="col_2">
              ...
              <label class="lb_1">
                <?= t('t_for_piso_destino'); ?>
              </label>
              <input class="caj1" id="piso_destino" name="piso_destino" data-name="piso_destino" type="text" placeholder="<?= t('t_for_piso_destino'); ?>" required="required" />
              <label class="lb_1">
                <?= t('t_for_ascensor'); ?>
              </label>
