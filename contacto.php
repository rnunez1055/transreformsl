    ...
    <!-- End of body section HTML codes -->
      ...
      <div class="cuadro_cont">
        ...
        <div class="text_descr"><?= t('des_contacto');?>
          <form action="" method="post" id="frm-contacto">
            ...
            <fieldset>
              ...
              <div class="clear1"></div>
              <input class="bt_form" type="submit" value="<?= t('t_for_enviar');?>" />
              <input id="btn-limpiar" class="bt_form" type="reset" value="<?= t('t_for_limpiar');?>" />
            </fieldset>
          </form>
        </div>
