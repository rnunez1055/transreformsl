        ...
        <div class="header_c">
          ...
          <a href="#" class="color_1_idio">CAT</a>-->
            ...
            <div class="w-clearfix c_menu_c">
                <a href="contacto.php">
                    <div class="link_men_last <?php if ($_SESSION['vmnu'] == 'contacto') {
                                                    echo 'act';
                                                } else {
                                                    echo '';
                                                } ?>"><?= t('como_contactarnos'); ?>
                ...
                <a href="presupuesto.php">
                    <div class="link_men <?php if ($_SESSION['vmnu'] == 'presupuesto') {
                                                echo 'act';
                                            } else {
                                                echo '';
                                            } ?>"><?= t('presupuesto_mudanzas'); ?>
                    </div>
                </a>
                <a href="ser_almacen_guardamuebles.php">
                    <div class="link_men <?php if ($_SESSION['vmnu'] == 'guardamuebles') {
                                                echo 'act';
                                            } else {
                                                echo '';
                                            } ?>"><?= t('almacen_guardamuebles'); ?>
                    </div>
                </a>
                <a href="ser_mudanzas_local_nacionales.php">
                    <div class="link_men <?php if ($_SESSION['vmnu'] == 'servicios') {
                                                echo 'act';
                                            } else {
                                                echo '';
                                            } ?>"><?= t('nuestros_servicios_m'); ?>
                    </div>
                </a>
                <a href="quienes_somos_mision.php">
                    <div class="link_men <?php if ($_SESSION['vmnu'] == 'empresa') {
                                                echo 'act';
                                            } else {
                                                echo '';
                                            } ?>"><?= t('quienes_somos'); ?>
                ...
                <a href="index.php">
                    <div class="link_men <?php if ($_SESSION['vmnu'] == 'inicio') {
                                                echo 'act';
                                            } else {
                                                echo '';
                                            } ?>"><?= t('pagina_principal'); ?>
