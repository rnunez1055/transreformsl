jQuery(function ($) {
	$.fn.quicksearch = function (opt) {
		...
		function make_form_input()
		{
			...
			return '<input type="text" style="color:#ccc;" value="' + val + '" rel="' + options.randomElement  + '" class="' + options.inputClass + '" id="' + options.randomElement + '" /> ';
		}
		...
		function make_form()
		{
			...
			return make_form_input() + make_form_loader();
		}
