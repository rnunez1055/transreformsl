...
<div class="full_int">
  <div class="cent_cuad">
    ...
    <?php
			$_SESSION['submenu_vmnu']='cliente';
			include('mnu_empresa.php');
	  ?>
    <div class="cuadro_cont">
      <div class="title_desc"><?= t('title_cliente_ideal');?></div>
      <div class="text_descr"><?= t('des_cliente_ideal');?>
      </div>
      <div class="img_desc">
      
      <!--<a href="contenido/img/b_clienteideal.jpg" title="<?= t('title_cliente_ideal');?>"  class="html5lightbox" data-group=""><img src="contenido/img/b_clienteideal.jpg" alt="<?= t('title_cliente_ideal');?>" /></a>-->
      
      <?php if ($img = $objProd ->gObjImage()) : ?>
            <a href="upload/<?= $img ->target;?>" title="<?= t('title_cliente_ideal');?>"  class="html5lightbox" data-group="">
                <img src="upload/<?= $img ->target;?>" alt="<?= t('title_cliente_ideal');?>" />
            </a>
        <?php endif; ?>
