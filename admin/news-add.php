...
if (isset($_POST['submit'])) {
	...
	$objLoad ->{LBN_ADMIN_PAGE_EXCLUDE_2} = 1;
...
$(document).ready(function(){
	...
	$("input[name='date_create']").datepicker({"dateFormat": "dd/mm/yy"});
});
</script>
					...
					<table cellpadding="0" cellspacing="0" class="table-form"  >
						...
						<tr>
							...
							<tr>
								...
								<td><?php $objLoad ->qDate('date_create',  $objLoad ->date_create, 'width:86px', 'class="required"'); ?></td>
							</tr>	
							<tr>
								<th>Estado: </th>
