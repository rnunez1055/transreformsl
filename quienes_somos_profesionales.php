...
<div class="full_int">
  <div class="cent_cuad">
    ...
    <?php
			$_SESSION['submenu_vmnu']='profesionales';
			include('mnu_empresa.php');
	  ?>
    <div class="cuadro_cont">
      <div class="title_desc"><?= t('title_nuestros_profesionales');?></div>
      <div class="text_descr"><?= t('des_nuestros_profesionales');?></div>
      <div class="img_desc">
      
      
      <!--<a href="contenido/img/b_trabajaconnosotros.jpg" title="<?= t('title_nuestros_profesionales');?>"  class="html5lightbox" data-group=""><img src="contenido/img/b_trabajaconnosotros.jpg" alt="<?= t('title_nuestros_profesionales');?>" /></a>-->
      
      <?php if ($img = $objProd ->gObjImage()) : ?>
            <a href="upload/<?= $img ->target;?>" title="<?= t('title_nuestros_profesionales');?>"  class="html5lightbox" data-group="">
                <img src="upload/<?= $img ->target;?>" alt="<?= t('title_nuestros_profesionales');?>" />
            </a>
        <?php endif; ?>
