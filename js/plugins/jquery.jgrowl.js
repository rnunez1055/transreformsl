...
(function($) {
	...
	$.extend( $.fn.jGrowl.prototype , {
		...
		render: 		function( notification ) {
			...
			var notification = $(
				'<div class="jGrowl-notification '+o.themeClass+' ui-corner-all' + 
			...
			if ( $('div.jGrowl-notification:parent', self.element).size() > 1 && 
				...
				$(this.defaults.closerTemplate).addClass('jGrowl-closer '+this.defaults.themeClass+' ui-corner-all').addClass(this.defaults.theme)
